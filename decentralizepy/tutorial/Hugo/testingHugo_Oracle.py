...
from decentralizepy.node.Hugo.Hugo_Oracle_Client import Hugo_Oracle_Client
from decentralizepy.node.Hugo.Hugo_Oracle_TopologyBuilder import (
    Hugo_Oracle_TopologyBuilder,
)
...
if __name__ == "__main__":
    ...
    if sm == m_id:
        processes.append(
            mp.Process(
                target=EL_Oracle_TopologyBuilder,
                args=[
                    sr,
                    m_id,
                    l,
